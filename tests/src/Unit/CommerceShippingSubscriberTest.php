...
/**
 * Class CommerceShippingSubscriberTest
 *
 * @package Drupal\Tests\commerce_vipps\Unity
 * @coversDefaultClass \Drupal\commerce_vipps\EventSubscriber\CommerceShippingSubscriber
 * @group commerce_vipps
 */
class CommerceShippingSubscriberTest extends UnitTestCase {

  /**
   * @var \Drupal\commerce_vipps\EventSubscriber\CommerceShippingSubscriber
   */
  ...
  protected function setUp() {
    ...
    $pm = $this->prophesize(PackerManagerInterface::class);
    $this->subscriber = new CommerceShippingSubscriber(
      $etm->reveal(),
      $pm->reveal()
    );
  }
